...
def build():
    ...
    if proc.returncode != 0:
        print_fail("lFuzzer image was not properly built. Check output for details.")
        exit(1)
    print_pass("Successfully built lFuzzer Docker container.")
...
def rebuild():
    """
        ...
        """
    inpt = input(
        "Do you want to delete the lfuzzer image including all "
...
def delete():
    ...
    """
    inpt = input("Do you want to delete the lfuzzer and llvm image including "
