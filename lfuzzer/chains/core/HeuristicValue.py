...
class HeuristicValue:
    ...
    def calc_cov_heuristic(objs, parent_stack: List[str], inpt: str, knowledge: KnowledgeHandling) -> Tuple["HeuristicValue", Set[Tuple[Any, Any]], Set[Tuple[Any, Any]]]:
        ...
        for obj in objs:
            ...
            # elif not Utils.is_real_input_comparison(obj, Utils.max_index - 1) and last_was_real:
            #     last_was_real = False
            #     coverage_events += tmp_events
            #     tmp_events = []
            ...
            elif obj["type"] == "COVERAGE_EVENT" and ParsingStageExtractor.stages.get(curr_fun) == Stage.PARSING:
